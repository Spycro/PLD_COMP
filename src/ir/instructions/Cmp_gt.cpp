...
Cmp_gt::Cmp_gt(BasicBlock* bb_, SymbolTableElement leftVal_, SymbolTableElement rightVal_, SymbolTableElement dst_) : IRInstr(bb_),
                                                                                                                        leftVal(leftVal_),
                                                                                                                        rightVal(rightVal_),
                                                                                                                        dst(dst_){}
...
void Cmp_gt::gen_asm(std::ostream &o) {
    ...
    o << "\tsetg " << AL_REGISTER.getAsm() << std::endl;
