...
Cmp_le::Cmp_le(BasicBlock* bb_, SymbolTableElement leftVal_, SymbolTableElement rightVal_, SymbolTableElement dst_) : IRInstr(bb_),
                                                                                                                        leftVal(leftVal_),
                                                                                                                        rightVal(rightVal_),
                                                                                                                        dst(dst_){}
...
void Cmp_le::gen_asm(std::ostream &o) {
    ...
    o << "\tsetle " << AL_REGISTER.getAsm() << std::endl;
