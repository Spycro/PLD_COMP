...
Cmp_lt::Cmp_lt(BasicBlock* bb_, SymbolTableElement leftVal_, SymbolTableElement rightVal_, SymbolTableElement dst_) : IRInstr(bb_),
                                                                                                                        leftVal(leftVal_),
                                                                                                                        rightVal(rightVal_),
                                                                                                                        dst(dst_){}
...
void Cmp_lt::gen_asm(std::ostream &o) {
    ...
    o << "\tsetl " << AL_REGISTER.getAsm() << std::endl;
