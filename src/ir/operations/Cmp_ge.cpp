...
Cmp_ge::Cmp_ge(BasicBlock* bb_, SymbolTableElement rightParameter_, SymbolTableElement leftParameter_, SymbolTableElement d_) : IRInstr(bb_), rightParameter(rightParameter_), leftParameter(leftParameter_), d(d_){}
