...
shared_ptr<SymbolTableElement> SymbolTable::addVariable (string variableName, VarType::Type* variableType, int mem64) {
...
shared_ptr<SymbolTableElement> SymbolTable::addFunction (string functionName, VarType::Type* functionReturnType, int mem64) {
