...
antlrcpp::Any Visitor::visitAxiom(ifccParser::AxiomContext *context) UNHANDLED
...
antlrcpp::Any Visitor::visitProg(ifccParser::ProgContext *context) UNHANDLED

antlrcpp::Any Visitor::visitMainFunction(ifccParser::MainFunctionContext *context) UNHANDLED
...
antlrcpp::Any Visitor::visitBlock(ifccParser::BlockContext *context) UNHANDLED
